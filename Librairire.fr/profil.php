                            ...
                            <tr>
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="name" class="input-profile <?=$classValid?>" id="name" placeholder="Nom" size="32" disabled="disabled" value="<?php if(!empty($tabCorrectInput["name"])){echo $tabCorrectInput["name"];}else if(!empty($userTab["name"])){echo $userTab["name"];}else{echo "";} ?>">
                                ...
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="firstName" class="input-profile <?=$classValid?>" id="firstName" placeholder="Prénom" size="32" disabled="disabled" value="<?php if(isset($tabCorrectInput["firstName"])){echo $tabCorrectInput["firstName"];}else if(!empty($userTab["firstName"])){echo $userTab["firstName"];}else{echo "";} ?>">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="date" name="birthDate" class="input-profile <?=$classValid?>" id="birthDate" disabled="disabled" value="<?php if(!empty($tabCorrectInput["birthDate"])){echo $tabCorrectInput["birthDate"];}else if(!empty($userTab["birthDate"])){echo $userTab["birthDate"];}else{echo "";} ?>">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="input_label">
                                        ...
                                        <textarea class="adresse input-profile <?=$classValid?>" name="address" id="address" rows="3" disabled="disabled" ><?php if(isset($tabCorrectInput["address"])){echo $tabCorrectInput["address"];}else if(!empty($userTab["fullAddress"]["address"])){echo $userTab["fullAddress"]["address"];}else{echo "";} ?></textarea>
                            ...
                            <tr>
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="number" name="postalCode" class="input-profile <?=$classValid?>" id="postalCode" placeholder="Code postal" min="00000" max="99999" class="bouton" disabled="disabled" value="<?php if(isset($tabCorrectInput["postalCode"])){echo $tabCorrectInput["postalCode"];}else if(!empty($userTab["fullAddress"]["postalCode"])){echo $userTab["fullAddress"]["postalCode"];}else{echo "";} ?>">
                                ...
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="city" class="input-profile <?=$classValid?>" id="city" placeholder="Ville" disabled="disabled" value="<?php if(isset($tabCorrectInput["city"])){echo $tabCorrectInput["city"];}else if(!empty($userTab["fullAddress"]["city"])){echo $userTab["fullAddress"]["city"];}else{echo "";} ?>">
                            ...
                            <tr>
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="tel" name="phoneNumber" class="input-profile <?=$classValid?>" id="phoneNumber" placeholder="Téléphone" disabled="disabled" value="<?php if(isset($tabCorrectInput["phoneNumber"])){echo $tabCorrectInput["phoneNumber"];}else if(!empty($userTab["phoneNumber"])){echo $userTab["phoneNumber"];}else{echo "";} ?>">
                                ...
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="job" class="input-profile <?=$classValid?>" id="job" placeholder="Métier" disabled="disabled" value="<?php if(isset($tabCorrectInput["job"])){echo $tabCorrectInput["job"];}else if(!empty($userTab["job"])){echo $userTab["job"];}else{echo "";} ?>">
                            ...
                            <tr>
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="email" name="mail" id="mail" class="input-profile <?=$classValid?>" placeholder="Adresse mail" size="32" disabled="disabled" value="<?php if(isset($tabCorrectInput["mail"])){echo $tabCorrectInput["mail"];}else if(!empty($userTab["mail"])){echo $userTab["mail"];}else{echo "";} ?>">
                                ...
                                <td>
                                    <div class="input_label" id="divConfirmationMail">
                                        ...
                                        <input type="email" name="confirmationMail" id="confirmationMail" class="input-profile <?=$classValid?>" placeholder="Adresse mail" size="25" disabled="disabled" value="<?php if(isset($tabCorrectInput["confirmationMail"])){echo $tabCorrectInput["confirmationMail"];}else if(!empty($userTab["mail"])){echo $userTab["mail"];}else{echo "";} ?>">
