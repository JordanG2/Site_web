                    ...
                    <div id="formulaire">
                        ...
                        <div class="input-label2">
                            ...
                            <div class="input-label">
                                ...
                                <?php $classValid = (!empty($tabErrorMessage["name"])) ? 'invalidInput' : '' ?>
                                <input type="date" name="contactDate" id="date_de_contact" class="<?=$classValid?>" min="" style="width: 200px" value="<?php if(isset($tabCorrectInput["contactDate"])){echo $tabCorrectInput["contactDate"];}else {echo date("Y-m-d");}?>" required>
