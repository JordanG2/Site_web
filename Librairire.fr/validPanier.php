                            ...
                            <form name="form-validpan" id="form-validpan" action="./php/validpanProcess.php" method='post' onsubmit='return checkingForm("validpan")'>
                                ...
                                <div class="div_input">
                                    <div class="input_label">
                                        ...
                                        <textarea class="adresse input-validpan <?=$classValid?>" name="address" id="address" rows="3"><?php if(isset($tabCorrectInput["address"])){echo $tabCorrectInput["address"];}else if(!empty($userTab["fullAddress"]["address"])){echo $userTab["fullAddress"]["address"];}else{echo "";} ?></textarea>
                                ...
                                <div class="div_input">
                                    ...
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="city" class="input-validpan <?=$classValid?>" id="city" placeholder="Ville" value="<?php if(isset($tabCorrectInput["city"])){echo $tabCorrectInput["city"];}else if(!empty($userTab["fullAddress"]["city"])){echo $userTab["fullAddress"]["city"];}else{echo "";} ?>">
                                ...
                                <div class="div_input">
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="name" class="input-validpan <?=$classValid?>" id="name" placeholder="Nom" size="32" value="<?php if(!empty($tabCorrectInput["name"])){echo $tabCorrectInput["name"];}else if(!empty($userTab["name"])){echo $userTab["name"];}else{echo "";} ?>">
                                    ...
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="firstName" class="input-validpan <?=$classValid?>" id="firstName" placeholder="Prénom" size="32"  value="<?php if(isset($tabCorrectInput["firstName"])){echo $tabCorrectInput["firstName"];}else if(!empty($userTab["firstName"])){echo $userTab["firstName"];}else{echo "";} ?>">
