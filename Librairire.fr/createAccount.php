                            ...
                            <tr>
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="name" id="name" class="<?=$classValid?>" placeholder="Nom" size="32" value="<?php if(isset($tabCorrectInput["name"])){echo $tabCorrectInput["name"];}else{echo "";} ?>">
                                ...
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="firstName" id="firstName" class="<?=$classValid?>" placeholder="Prénom" size="32" value="<?php if(isset($tabCorrectInput["firstName"])){echo $tabCorrectInput["firstName"];}else{echo "";} ?>">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="date" name="birthDate" id="birthDate" class="<?=$classValid?>" value="<?php if(isset($tabCorrectInput["birthDate"])){echo $tabCorrectInput["birthDate"];}else{echo "";} ?>">
                            ...
                            <tr>
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="email" name="mail" id="mail" class="<?=$classValid?>" placeholder="Adresse mail" size="25" value="<?php if(isset($tabCorrectInput["mail"])){echo $tabCorrectInput["mail"];}else{echo "";} ?>">
                                ...
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="email" name="confirmationMail" id="confirmationMail" class="<?=$classValid?>" placeholder="Adresse mail" size="25" value="<?php if(isset($tabCorrectInput["confirmationMail"])){echo $tabCorrectInput["confirmationMail"];}else{echo "";} ?>">
                            ...
                            <tr>
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="password" name="password" id="password" class="<?=$classValid?>" placeholder="Mot de passe">
                                ...
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="password" name="confirmationPassword" id="confirmationPassword" class="<?=$classValid?>" placeholder="Mot de passe">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="input_label">
                                        ...
                                        <textarea class="adresse" name="address" id="address" class="<?=$classValid?>" rows="3" ><?php if(isset($tabCorrectInput["address"])){echo $tabCorrectInput["address"];}else{echo "";} ?></textarea>
                            ...
                            <tr>
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="number" name="postalCode" id="postalCode" class="<?=$classValid?>" placeholder="Code postal" min="00000" max="99999" class="bouton" value="<?php if(isset($tabCorrectInput["postalCode"])){echo $tabCorrectInput["postalCode"];}else{echo "";} ?>">
                                ...
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="city" id="city" class="<?=$classValid?>" placeholder="Ville" value="<?php if(isset($tabCorrectInput["city"])){echo $tabCorrectInput["city"];}else{echo "";} ?>">
                            ...
                            <tr>
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="tel" name="phoneNumber" id="phoneNumber" class="<?=$classValid?>" placeholder="Téléphone" value="<?php if(isset($tabCorrectInput["phoneNumber"])){echo $tabCorrectInput["phoneNumber"];}else{echo "";} ?>">
                                ...
                                <td>
                                    <div class="input_label">
                                        ...
                                        <input type="text" name="job" id="job" class="<?=$classValid?>" placeholder="Métier" value="<?php if(isset($tabCorrectInput["job"])){echo $tabCorrectInput["job"];}else{echo "";} ?>">
